...
class GiveItemsCommand : CommandExecutor {
    override fun onCommand(
        ...
        Chat.sendMessage(sender, "${Chat.prefix} Given items to ${Chat.secondaryColor}${target.name}&7.")
        Chat.sendMessage(target, "${Chat.prefix} You received items from ${Chat.secondaryColor}${sender.name}&7.")
        return true
    }
