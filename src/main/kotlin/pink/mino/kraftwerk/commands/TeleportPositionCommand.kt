...
class TeleportPositionCommand : CommandExecutor {
    override fun onCommand(
        ...
        if (args.isEmpty()) {
            Chat.sendMessage(sender, "${Chat.prefix} Invalid usage: ${Chat.secondaryColor}/tppos <x> <y> <z>&7.")
            return false
        }
        if (args.size != 3) {
            Chat.sendMessage(sender, "${Chat.prefix} Invalid usage: ${Chat.secondaryColor}/tppos <x> <y> <z>&7.")
        ...
        Chat.sendMessage(sender, "${Chat.prefix} Teleported to ${Chat.secondaryColor}${args[0]}&7, ${Chat.secondaryColor}${args[1]}&7, ${Chat.secondaryColor}${args[2]}&7.")
        return true
    }
}