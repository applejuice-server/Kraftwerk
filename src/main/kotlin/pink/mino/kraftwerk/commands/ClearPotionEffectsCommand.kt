        ...
        if (args.isEmpty()) {
            ...
            if (args[0] == "*") {
                for (online in ArrayList(Bukkit.getServer().onlinePlayers)) {
                    ...
                    Chat.sendMessage(online, "${Chat.prefix} &7Your effects have been cleared by &c${sender.name}&7.")
                }
                ...
                Chat.sendMessage(sender as Player, "${Chat.prefix} &7Cleared the effects of &c${target.name}&7.")
                Chat.sendMessage(target, "${Chat.prefix} &7Your effects have been cleared by &c${sender.name}&7.")
                return true
            }
        }
    }
