...
class ForceCommand : CommandExecutor {
    override fun onCommand(
        ...
        if (args[0] == "start") {
            ...
            Bukkit.broadcastMessage(Chat.colored("${Chat.prefix} &f${sender.name}&7 has forced &eBorder Shrinks&7."))
        } else {
            Chat.sendMessage(sender, "${Chat.prefix} Invalid usage: &f/force <start/fh/pvp/meetup/bs>&7.")
            return false
        }
        return true
    }
